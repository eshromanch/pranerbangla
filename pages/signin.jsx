...
function signin(props) {
    return (
        <div>
            ...
            <LogoChange/>
            <h1 className='font-enbody font-semibold text-4xl text-center text-black dark:text-white w-[35rem] '>Join millions of readers from the region</h1>
            <p className='font-enbody text-xl text-center text-black dark:text-white w-[35rem]'>Access and engage on thousands of original, refreshing, and inspiring stories which capture the vibrancy of the South Asian region. And if you’ve got a story to tell, we’ve got a platform for you.</p>
