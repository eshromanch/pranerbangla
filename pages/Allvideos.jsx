        ...
        {dataAll?.map((group) => {
            return (
              <div key={group?.id} className='w-full mt-24'>
                  <div className="grid grid-cols-4 mb-4 gap-10 mx-48 lg:mx-10  md:mx-5 md:grid-cols-2 md:gap-5" >
                   
          {
           group?.vid?.map(items => {
            return <Video key={items.id} link={items.video_url} img={items.image}/>
                  ...
                  <div className='mx-48 flex justify-center items-center lg:mx-10 md:mx-5'>   
