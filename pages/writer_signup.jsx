...
function Writer_signup(props) {
      ...
      const handleSubmit = async (event) => {
        ...
        const endpoint = 'https://pranerbangla.com.bd/api/vb1/writer-register'
    ...
    {/* <Link><a href=""><h1 className='font-enbody font-semibold text-xl text-center text-black dark:text-white' >Sign Up here</h1></a></Link> */}
                    ...
                    <form onSubmit={handleSubmit} className=" flex flex-col gap-4 font-enbody md:justify-center " >
