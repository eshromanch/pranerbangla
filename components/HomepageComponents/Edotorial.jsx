...
function Edotorial(props) {
    ...
    return (
        ...
        <div className='flex flex-col  card rounded-md   shadow-lg'>
        ...
        <img src="koli-pranerbangla.png" alt="" className=" w-36 h-36 rounded-full object-cover border-2 border-primary absolute  -translate-y-16"></img>
          ...
          <p className='my-8 text-base text-black dark:text-white px-4' dangerouslySetInnerHTML={{ __html: data?.content_bn }}></p>
