...
<figure className='group h-full w-full relative traansform transition cursor-pointer  hover:scale-110 group-hover:shadow hover:shadow-inner-lg '><Icons className="absolute h-12 m-2 group-hover:m-10  duration-300 md:h-5"/> <img  className='hedarBal object-fill  ' src={props.img} alt="" />
