...
useEffect(()=>{
  ...
  // loop
    >
      {data?.map(items=>{
        return (
          <SwiperSlide key={items.id}><Link key={items.id} href={`categories/9/articles/${items.id}`} legacyBehavior><div className="w-full h-[20rem] relative flex justify-center  ">
